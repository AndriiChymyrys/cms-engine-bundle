...
final class Version20221116082852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cms_content (id INT DEFAULT nextval(\'cms_content_id_seq\'), content_block_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE cms_widget (id INT DEFAULT nextval(\'cms_widget_id_seq\'), content_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, config JSONB DEFAULT NULL, widget_order INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, theme VARCHAR(255) NOT NULL, layout VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
