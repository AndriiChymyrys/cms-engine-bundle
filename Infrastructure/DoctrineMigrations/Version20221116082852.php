...
final class Version20221116082852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cms_widget (id INT DEFAULT nextval(\'cms_widget_id_seq\'), content_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, config JSONB DEFAULT NULL, widget_order INT DEFAULT 1 NOT NULL, provide_theme VARCHAR(255) NOT NULL, theme VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, layout VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
